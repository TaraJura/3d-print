...
[Aktuální program pro UNO R4 WiFi](../../models/jednoduche-auticko/firmware/prvni-motor/prvni-motor.ino) a [návod k firmwaru](../../models/jednoduche-auticko/firmware/prvni-motor/README.md) popisují opravu hold-to-run-v2 a skutečný stav uploadu. D5/D7/D8 a PWM 128/255 se nemění. Limit je500 ms od posledního platného HOLD; při ztraceném STOP může jediný již odeslaný HOLD prodloužit dobu do vypnutí až na1 s od puštění. Fyzický doběh a latence telefonu nejsou změřené. Těžký rozjezd i na starém programu zůstává samostatný [nevyřešený bod](potize-po-montazi.md).
