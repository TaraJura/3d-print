...
def relabel_delivered(source, target, plate):
    ...
    old_title = f"Držák se zásuvkou – podložka {plate:02d}, pouze geometrie"
    new_title = f"Držák se zásuvkou – podložka {plate:02d}, nastavený a nařezaný projekt"
...
def main():
    ...
    process.update({
        "name": "Drzak se zasuvkou 0.20 mm PLA navrh Kobra X",
        "print_settings_id": "Drzak se zasuvkou 0.20 mm PLA navrh Kobra X",
