# Historická dokumentace sekundového testu

Archiv stavu před změnou na ovládání při držení dne 19. 9. 2026. Slova „aktuální“ a časové údaje níže se vztahují k této starší etapě, nikoli k nynější verzi. Platný návod je v [README](README.md); podrobná historie je také v [elektronice autíčka](../../../../elektronika/auticko/README.md).
