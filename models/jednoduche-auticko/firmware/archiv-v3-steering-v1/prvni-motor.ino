...
const char BUILD_ID[] = "v3-steering-v1";
constexpr uint8_t EN = 5, IN1 = 7, IN2 = 8, STEER_PIN = 9;
constexpr uint16_t STEER_CENTER_US=1500, STEER_OFFSET_US=150;
constexpr int8_t STEER_SIGN=1; // Ověřit směr s odpojeným táhlem; ±150 us není změřený úhel.
...
bool initializeSafety() {
  ...
  // Startup deliberately commands nominal1500us; first set up without linkage.
