...
**Navazující skutečný CAD:** [aktuální návrh B](../README.md) má celkovou délku570 mm, šířku nejvýše20 mm a cílovou instalační výšku přibližně10 mm: TPU tělo8 mm + nominální2mm lepicí lože. Tři díly193 /200 /193 mm,2mm lepicí mezery ve stupňovitých spojích a2mm koncové prostory jsou konstrukční návrh. Jiří schválil zachování tohoto lože a mezer. Dřívějších40 mm šířky bylo nahrazeno limitem20 mm; reference samotného10mm těla s nulovou vůlí je pouze v historii.

Jiří potvrdil TPU; dostupný výrobek je Alzament TPU95A Gray. Podkladem je podle jeho hlášení jedna dlouhá hladká kachlička bez spár pod lištou. Aktuální zdroje, kontroly, skutečné CAD náhledy, montážní vzorek a tiskový stav jsou v nadřazeném README. Zdejší původní srovnání A/B/C zůstává orientační bez měřítka a není aktuální konstrukční dokumentací.
