...
assert source['generator_sha256'] == sha((ROOT / 'kalibrace.FCMacro').read_bytes())
report = {'generator_sha256': source['generator_sha256'], 'files': {}, 'stl': {}}
for name in ['kalibrace.FCStd', 'kalibracni-dily.zip', 'nahled.FCMacro', 'nahled.png', 'README.md', 'kontrola-kalibrace.json']:
...
with zipfile.ZipFile(ROOT / 'kalibracni-dily.zip') as z:
...
print('PASS: 8 STL, 8 ZIP copies, manifold/orientation/dimensions/Z0/links/source hash')
