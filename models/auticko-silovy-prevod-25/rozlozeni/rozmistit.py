...
assert out.resolve()!=Path(__file__).resolve().parent, 'Historical horizontal packer may not overwrite canonical upright manifest. Use a new scratch directory and the current orientation generator.'
raw={}; meshes={}
