...
assert not any('rotation_matrix' in i for i in d['items']), 'Historical planar checker cannot certify upright geometry; use stojate-cepy-2026-09-20/pripravit.py and overit.py.'
