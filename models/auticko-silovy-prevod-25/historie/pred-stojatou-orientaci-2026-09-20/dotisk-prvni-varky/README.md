...
**Dotisknout 7 kusů na třech samostatných podložkách.** Druhá původní várka právě tiskne; jejích 27 kusů zde není. Původní třetí podložka se 13 kusy zůstává samostatným plánovaným tiskem.
...
|---|---:|---|
| [01 — zadní osa, nastavený projekt](projekty-next/dotisk-25-01-nastaveny-projekt.3mf) | 1 | Normal auto / Snug, zapnuté; vnější brim 8 mm |
...
**Tyto projekty záměrně načítají své tiskové a materiálové nastavení.** Používají systémový Anycubic PLA jako výchozí procesní podklad, nikoli kalibrovaný profil konkrétního Alzamentu. Vlastní uložené presety nebyly měněné; v otevřeném projektu však platí načtené hodnoty. Jediný rozdíl konfigurace proti ověřenému místnímu řezu je srozumitelnější název procesu `Dotisk V3 - …`; geometrie a všechny ostatní položky konfigurace jsou shodné. [Ověření skutečných projektů](overeni-projektu-next.json).
...
|---|---:|---|---|
| [01 — zadní osa](dotisk-25-podlozka-01.3mf) | 1 | Podpory zapnout + vnější brim 8 mm | [PNG](podlozka-01.png) |
...
- **Brim: Outer brim / vnější, 8 mm, mezera 0,1 mm**. Zvol vnější brim výslovně, nikoli Auto. Brim drží první vrstvu; nenahrazuje podpory.
...
- První vrstva **20 mm/s**, vnější stěny nejvýše **30 mm/s**, vnitřní **50 mm/s**, malé obvody **20 mm/s** (práh 20 mm), podpory **40 mm/s**, jejich rozhraní **30 mm/s**. Výchozí zrychlení **1000 mm/s²**, vnější stěny/první vrstva **500 mm/s²**. Úplný seznam změn je v [JSON nastavení](doporucene-nastaveni.json).
...
Po řezu zkontroluj v náhledu **skutečné podpory pod celou osou a pod tělem, ramenem, kapsou a boční osičkou těhlice**. U čepů má být pět oddělených hlav s brimem a žádné podpory v drážkách. Srovnání skutečně vypočtených drah: [osa](evidence/drahy-01.png), [těhlice](evidence/drahy-02.png), [čepy](evidence/drahy-03.png). Neodesílat znovu původní G-code s vypnutými podporami.
...
Bilance celé sestavy: **19 zachovaných + 7 náhrad + 27 ve druhé běžící várce + 13 na původní třetí podložce = 66 dílů**. Druhá várka ještě nemá potvrzené dokončení ani kvalitu. Obsahuje levou těhlici a další ležaté čepy se stejným rizikem převisů; posoudit až její skutečný výsledek. Levá těhlice není omylem zahrnutá do tohoto dotisku. Původní [třetí podložka](../auticko-25-podlozka-03.3mf) je zbývající plánovaný tisk, nikoli oprava první.
...
- Zadní osa zůstává **vodorovně**, otočená o 180° kolem své dlouhé osy: D plošky jsou nahoře, příčný otvor zůstává svislý, spodní kruhový oblouk pokračuje do konců. Podpory jsou stále nutné. Nestavíme 150,6mm osu na konec.
...
- [Geometrie a počty](overeni-dotisku.json): 7 kopií, 1 / 1 / 5 objektů, všech **19 446 trojúhelníků** shodných se zdrojem po tuhém otočení/posunu, uzavřené sítě, kladné objemy, Z0 a měřítko 1:1. Nejmenší mezera **32,5 mm**, okraj **54,7 mm**. Každý 3MF byl znovu otevřen a porovnán se zdrojem; nezávislý audit souhlasí.
...
- Odhady tohoto pomalého plného procesu: **01: 2 h 44 min / 20,35 g; 02: 1 h 21 min / 6,55 g; 03: 1 h 54 min / 7,77 g**. To jsou odhady sliceru, nikoli skutečné časy nebo spotřeba.
