...
p=argparse.ArgumentParser();p.add_argument('layout_json');p.add_argument('output_dir');p.add_argument('--input-zip');p.add_argument('--title',default='Ruční zkouška 18→60 — 7 dílů');a=p.parse_args()
